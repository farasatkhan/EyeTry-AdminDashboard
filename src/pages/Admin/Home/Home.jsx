  ...
  return (
    <div className="flex flex-col my-10">
      ...
      <div className="flex flex-col lg:flex-row gap-5 mx-7 mt-5">
        <div className="w-full lg:w-2/3 border shadow-sm rounded-lg">
          <div className="px-5 py-5">
            <h1 className="text-xl font-bold">Sales</h1>
            <p>Sales in the past month</p>
          </div>
          <div className="w-full h-0.5 bg-slate-100"></div>
          <div className="mt-10 h-full max-h-80">
            <Sales />
          </div>
        </div>
        <div className="w-full lg:w-1/3 border shadow-sm rounded-lg mt-5 lg:mt-0">
          <div className="px-5 py-5">
