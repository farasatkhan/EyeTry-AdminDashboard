    ...
    <body>
      <div className='flex px-40 mt-10'>
        <div className='px-5 pt-12'>
          ...
          <p className='text-3xl mt-5 pt-4'>We couldn’t find this page. Don’t let this stop you and keep browsing. </p>
          <div className='flex flex-1 mt-7 gap-5'>
            <div className='border px-4 py-2 rounded-full bg-slate-900 hover:bg-slate-800'>
              <p className='text-white'><a href="">Go to home</a></p>
            </div>
            <div className='border px-4 py-2 rounded-full border-slate-900'>
              <p className='text-slate-900'><a href="">Previous Page</a></p>
            </div>
          </div>
        </div>
        <div className=''>
